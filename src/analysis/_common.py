...
# ---------------------------------------------------------------------------
# Denominations: (name, pence_value)  — 10 coins, farthing to sovereign
# ---------------------------------------------------------------------------
DENOMINATIONS = [
    ("farthing",  0.25),
    ("halfpenny", 0.5),
...
# ---------------------------------------------------------------------------
YEAR_PROBE_YEARS = list(range(1200, 1901, 50))   # 1200, 1250, … 1900

# ---------------------------------------------------------------------------
# Test years for the coin × time 2D probe
# ---------------------------------------------------------------------------
TEST_YEARS = list(range(1250, 1926, 25))  # 1250, 1275, … 1925  (28 points)
